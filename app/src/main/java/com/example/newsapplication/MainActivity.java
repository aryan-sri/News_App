...
public class MainActivity extends AppCompatActivity implements CategoryRVAdapter.CategorClickInterface{
    ...
    private void getCategories()
    {
        ...
        categoryRVModalArrayList.add(new CategoryRVModal("Sports","https://images.unsplash.com/photo-1614935151651-0bea6508db6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fFNjaWVuY2V8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"));
